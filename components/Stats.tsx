...
export default function Stats() {
  const { followers, followings, notFollowing, setCurrentListView } = useContext(DataContext);
  ...
  return (
    <div className="w-full my-8 lg:mt-0 p-4 sm:p-8 border-[1px] border-zinc-800 rounded-xl">
        ...
        <div className="flex justify-around items-center mt-4">
          <div onClick={() => setCurrentListView("Followers")} className="cursor-pointer flex flex-col items-center">
          ...
          <div onClick={() => setCurrentListView("Followings")} className="cursor-pointer flex flex-col items-center">
          ...
          <div onClick={() => setCurrentListView("Not Following")} className="cursor-pointer flex flex-col items-center">
